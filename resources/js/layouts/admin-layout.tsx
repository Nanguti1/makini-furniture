        ...
        <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            {mobileMenuOpen && (
                <div className="fixed inset-0 z-50 lg:hidden">
                    ...
                    />
                    <div className="absolute left-0 top-0 h-full w-64 bg-navy shadow-lg overflow-y-auto">
                        <div className="p-4 border-b border-primary/20">
                            <div className="flex justify-between items-center">
                                <span className="text-lg font-bold text-gold-metallic">Makini Queens Furnitures</span>
                                <Button
                                    variant="ghost"
                                    size="icon"
