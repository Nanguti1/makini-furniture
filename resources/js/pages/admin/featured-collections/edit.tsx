...
export default function FeaturedCollectionEdit({ featuredCollection, collections = [] }: FeaturedCollectionEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        ends_at: featuredCollection.ends_at ? featuredCollection.ends_at.slice(0, 16) : '',
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Update featured collection settings
                        </p>
                    </div>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex items-center gap-4 pt-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Updating...' : 'Update Featured Collection'}
                                </Button>
                                <Link href={admin.featuredCollections.index.url()}>
