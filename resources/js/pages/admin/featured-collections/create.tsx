...
interface FeaturedCollectionCreateProps {
    collections?: Array<{
        id: number;
        name: string;
        slug: string;
...
export default function FeaturedCollectionCreate({ collections = [] }: FeaturedCollectionCreateProps) {
        ...
        <AdminLayout breadcrumbs={breadcrumbs}>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Add a collection to featured sections
                        </p>
                    </div>
                    <Link href={admin.featuredCollections.index.url()}>
                ...
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            <CardTitle>Featured Collection Details</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex items-center gap-4 pt-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Creating...' : 'Feature Collection'}
                                </Button>
                                <Link href={admin.featuredCollections.index.url()}>
