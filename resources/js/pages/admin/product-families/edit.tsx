...
interface ProductFamilyEditProps {
    productFamily: {
        id: number;
...
export default function ProductFamilyEdit({ productFamily, brands = [], collections = [] }: ProductFamilyEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        brand_id: productFamily.brand_id || '',
        collection_id: productFamily.collection_id || '',
        name: productFamily.name,
        slug: productFamily.slug,
        description: productFamily.description || '',
        hero_image: productFamily.hero_image || '',
        is_active: productFamily.is_active,
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Update product family information
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-end gap-4">
                                ...
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Updating...' : 'Update Product Family'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
