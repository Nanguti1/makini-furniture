...
class BrandController extends Controller {
 ...
 public function edit(Brand $brand): Response { $this->authorize('update', $brand); return Inertia::render('admin/brands/edit',['brand'=>$brand,'breadcrumbs'=>[['title'=>'Brands','href'=>route('admin.brands.index')],['title'=>'Edit','href'=>route('admin.brands.edit',$brand)]]]); }
